...
export const MessagesPage = () => {
    ...
    useEffect(() => {
        if (conversations?.length > 0 && !selectedUserId && window.innerWidth >= 768) {
    ...
    return (
        <div className="h-[calc(100vh-120px)] md:h-[calc(100vh-120px)] bg-white rounded-xl border border-neutral-200 flex overflow-hidden">
            {/* Conversations List - hidden on mobile when conversation selected */}
            <div className={`${selectedUserId ? 'hidden md:flex' : 'flex'} w-full md:w-80 border-r border-neutral-200 flex-col`}>
                {/* Search Header */}
                <div className="p-4 border-b border-neutral-100">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 border border-neutral-200 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                        />
                    </div>
                </div>
                ...
                <div className={`${selectedUserId ? 'flex' : 'hidden md:flex'} flex-1 flex-col`}>
                        ...
                        {isLoadingMessages ? (
                            ...
                            messages.map((message) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`max-w-[85%] md:max-w-[70%] px-4 py-2 rounded-2xl ${isOwnMessage
                    ...
                    <div className="p-3 md:p-4 border-t border-neutral-200">
                        <div className="flex items-center gap-2 md:gap-3">
                            <button className="hidden md:block p-2 hover:bg-neutral-100 rounded-lg transition-colors">
                            ...
                            <input
                                ...
                                className="flex-1 px-4 py-3 min-h-[44px] border border-neutral-200 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                            />
                            <Button
